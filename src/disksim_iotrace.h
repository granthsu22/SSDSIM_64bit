...
int first_enter_iotrace; // wendy
ioreq_event *advanced; // wendy

int pagesize_in_disksim; // wendy: for disksim_iotrace to know page size to align trace
int max_lba_in_disksim; // wendy: for disksim_iotrace to limit lba

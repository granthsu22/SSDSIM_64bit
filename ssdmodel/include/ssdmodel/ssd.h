...
#include "disksim_iodriver.h" // add by wendy
#include "config.h"

extern int pagesize_in_disksim; // wendy: for disksim_iotrace to know page size to align trace
...
// add by wendy
int die_state[MAX_DIE_NUM];
int die_pending_request[MAX_DIE_NUM];
